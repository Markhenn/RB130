...
#
# Problem
# pass as many items to the block as indicated by value
# input: array, int
# output nil
#
# Algorithm
# break when index + cons is bigger to array.size 
#

def each_cons(array, consecutives)
  array.each_with_index do |value, index|
    break if index + consecutives > array.size
    yield(*array[index, consecutives])
  end
end
