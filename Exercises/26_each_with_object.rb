...
# Problem
# recreate each with object
# input: an an array, an empty collection object
# output: the filled collection object
#
# Algorithm
# call each on array
#  pass value and collection object to yield
# return collection object

def each_with_object(array, collection)
  array.each do |value|
    yield(value, collection)
  end
  collection
end
