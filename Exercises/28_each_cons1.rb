...
# Problem
# hand over two consecutive items from collection to block
# input: array
# output: nil
#
# iterate over the collection and pass in two consecutives
#  start at 1 and 2, 2, 3 ... stop on the last element
#
# Algorithm
# set index to 1
# while index is smaller than array size 
#  pass index -1 and index to yield
#  increment index
